  ...
  auto: [
    {
      ...
      phone: '+919876543270',
      lineItems: [
        { serviceName: 'Regular Periodic Service (10k KM)', quantity: 1, unitPrice: 8500, gstRate: 18, gstAmount: 1530, totalPrice: 10030 }
      ],
      subtotal: 8500,
      totalGst: 1530,
      discountType: 'amount',
    ...
    },
    {
      ...
      phone: '+919876543271',
      lineItems: [
        { serviceName: 'Synthetic Engine Oil Change', quantity: 1, unitPrice: 3500, gstRate: 18, gstAmount: 630, totalPrice: 4130 },
        { serviceName: 'Oil Filter Replacement', quantity: 1, unitPrice: 450, gstRate: 18, gstAmount: 81, totalPrice: 531 }
      ],
      subtotal: 3950,
      totalGst: 711,
      discountType: 'amount',
    ...
    },
    {
      ...
      phone: '+919876543272',
      lineItems: [
        { serviceName: 'Brake Pad Replacement (Front)', quantity: 1, unitPrice: 4500, gstRate: 18, gstAmount: 810, totalPrice: 5310 }
      ],
      subtotal: 4500,
      totalGst: 810,
      discountType: 'amount',
    ...
    },
    {
      ...
      phone: '+919876543273',
      lineItems: [
        { serviceName: 'Ceramic Coating Package', quantity: 1, unitPrice: 25000, gstRate: 18, gstAmount: 4500, totalPrice: 29500 }
      ],
      subtotal: 25000,
      totalGst: 4500,
      discountType: 'amount',
    ...
    },
    {
      ...
      phone: '+919876543274',
      lineItems: [
        { serviceName: 'AC Gas Refill & Service', quantity: 1, unitPrice: 2800, gstRate: 18, gstAmount: 504, totalPrice: 3304 }
      ],
      subtotal: 2800,
      totalGst: 504,
      discountType: 'amount',
    ...
    },
    {
      ...
      invoiceNo: 'INV-2026-0006',
      nicheId: 'auto',
      customerName: 'Ajay Devgn',
      phone: '+919876543275',
      lineItems: [
        { serviceName: 'Premium Car Wash', quantity: 1, unitPrice: 800, gstRate: 18, gstAmount: 144, totalPrice: 944 }
      ],
      subtotal: 800,
      totalGst: 144,
      discountType: 'amount',
