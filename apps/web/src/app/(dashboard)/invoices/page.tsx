            ...
            >
              <div className="flex items-center justify-between border-b border-[var(--color-border)] pb-3">
                <h3 className="font-bold text-base flex items-center gap-2 text-[var(--color-text)]">
                  ...
                  Create {nicheConfig.terminology?.customer || 'Patient'} Invoice / Bill
                </h3>
              ...
              <form onSubmit={handleCreateInvoice} className="space-y-3">
                <div>
                  <label className="block text-xs font-medium text-[var(--color-text-muted)] mb-1">{nicheConfig.terminology?.customer || 'Patient'} Full Name *</label>
                  <input
                    type="text"
                    required
                    value={customer}
                    ...
                    className="w-full px-3.5 py-2 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                ...
                <div>
                  <label className="block text-xs font-medium text-[var(--color-text-muted)] mb-1">{nicheConfig.terminology?.service || 'Treatment'} Billed *</label>
                  <input
                    type="text"
                    required
                    value={service}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-xs text-[var(--color-text)] font-mono"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-[var(--color-text-muted)] mb-1">Due Date</label>
                    <input
                      type="date"
                      value={dueDate}
                ...
                <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-xl text-xs text-purple-600 dark:text-purple-300">
                ...
                <div className="flex justify-end gap-3 pt-3 border-t border-[var(--color-border)]">
                  <button
                    ...
                    className="px-4 py-2 bg-[var(--color-surface-hover)] border border-[var(--color-border)] text-[var(--color-text-muted)] hover:text-[var(--color-text)] text-xs rounded-lg font-medium"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs rounded-lg font-medium transition-colors cursor-pointer shadow-md"
                  >
                    Generate Invoice
                  </button>
                </div>
