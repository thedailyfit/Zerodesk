  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center p-6 text-center">
      <div className="max-w-md rounded-2xl border border-red-500/20 bg-red-500/10 p-6">
        ...
        <h3 className="text-lg font-semibold text-white mb-2">Failed to load conversation inbox</h3>
        <p className="text-sm text-slate-400 mb-4">{error.message || 'Unable to connect to live message streams.'}</p>
        <button
          onClick={reset}
