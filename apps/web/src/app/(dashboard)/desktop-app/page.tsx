  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* EXE Installer */}
        <div className="p-6 rounded-2xl bg-[var(--color-glass)] backdrop-blur border border-cyan-500/30 space-y-4 relative overflow-hidden group">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">ZeroDesk_Installer_x64.exe</h2>
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/20 transition-all hover:scale-[1.01] active:scale-95 disabled:opacity-50"
          >
            {downloading === 'exe' ? (
        ...
        <div className="p-6 rounded-2xl bg-[var(--color-glass)] backdrop-blur border border-purple-500/30 space-y-4 relative overflow-hidden group">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">ZeroDesk_Enterprise_x64.msi</h2>
            <p className="text-xs text-[var(--color-text-muted)] mt-1">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-purple-500/20 transition-all hover:scale-[1.01] active:scale-95 disabled:opacity-50"
          >
            {downloading === 'msi' ? (
              <RefreshCw size={16} className="animate-spin" />
            ) : (
      ...
      <div className="p-6 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 font-bold text-xs border border-amber-500/30 flex items-center gap-2 shrink-0 transition-all"
          >
            <Zap size={14} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          <div className="p-4 rounded-xl bg-[var(--color-bg)] border border-[var(--color-border)] space-y-1.5 text-xs">
            <span className="font-mono text-[10px] text-cyan-400 font-bold uppercase">Cross-Device Sync</span>
            <p className="font-bold text-white">Real-Time Cloud Synchronization</p>
          ...
          <div className="p-4 rounded-xl bg-[var(--color-bg)] border border-[var(--color-border)] space-y-1.5 text-xs">
            <span className="font-mono text-[10px] text-purple-400 font-bold uppercase">Engine Isolation</span>
            <p className="font-bold text-white">PostgreSQL RLS Protected</p>
          ...
          <div className="p-4 rounded-xl bg-[var(--color-bg)] border border-[var(--color-border)] space-y-1.5 text-xs">
            <span className="font-mono text-[10px] text-emerald-400 font-bold uppercase">Offline Resiliency</span>
            <p className="font-bold text-white">Background Queue Buffer</p>
